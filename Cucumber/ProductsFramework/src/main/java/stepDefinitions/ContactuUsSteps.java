...
public class ContactuUsSteps {
	WebDriver driver;
	
	@Before()
	public void setup() throws IOException{
		System.setProperty("webdriver.chrome.driver", Paths.get(System.getProperty("user.dir")).toRealPath() + "\\src\\test\\java\\cucumberframework\\resources\\other\\chromedriver.exe");
	...
	public void the_information_should_successfully_be_submitted_via_the_contact_us_form() throws InterruptedException {
		...
		WebElement thanksContactUsPage = driver.findElement(By.xpath("//h1[contains(text(),'Thank You for your Message!')]"));
		
		// expected actual
		// A simpler way
		Assert.assertEquals("Thank You for your Message!", thanksContactUsPage.getText());
		
		// Video instructor's way:
